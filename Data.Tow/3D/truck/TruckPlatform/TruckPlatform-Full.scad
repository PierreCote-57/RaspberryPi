...
// ClickHole
				...
				translate(v=[345.000, 65.000, 28.000])
				{
					rotate(a=[0.000, 0.000, 90.000])
					{
// ClickHole
...
// HoodPlatform
		difference()
		{
			translate(v=[315.000, 0.000, 28.000])
			{
				translate(v=[0.000, 0.000, 2.000])
				{
					cube(size=[90.000, 152.000, 4.000], center=true);
				}
			}
			translate(v=[315.000, 0.000, 28.000])
			{
// ModuleHole
				color(c=[1.000, 0.000, 1.000])
				{
					union()
					{
						translate(v=[0.000, 35.000, 0.000])
						{
							translate(v=[31.000, -21.000, 4.000])
							{
...
// Servo_2040
						...
						translate(v=[0.000, -35.000, 0.000])
						{
							translate(v=[26.000, -19.000, 4.000])
							{
								rotate(a=[0.000, 180.000, 0.000])
								{
// Motor_2040
						...
						translate(v=[-5.000, 0.000, 0.000])
						{
							rotate(a=[0.000, 0.000, 90.000])
							{
								translate(v=[11.000, -17.500, 4.000])
								{
									rotate(a=[0.000, 180.000, 0.000])
									{
// MQ_2
										union()
										{
											...
											translate(v=[2.500, 32.500, 0.000])
											{
												color(c=[1.000, 0.784, 0.000])
												{
													translate(v=[0.000, 0.000, 4.000])
											...
											translate(v=[19.500, 32.500, 0.000])
											{
												color(c=[1.000, 0.784, 0.000])
												{
													translate(v=[0.000, 0.000, 4.000])
						...
						{
							translate(v=[10.000, -10.000, 4.000])
							{
								rotate(a=[0.000, 180.000, 0.000])
								{
// RGB
