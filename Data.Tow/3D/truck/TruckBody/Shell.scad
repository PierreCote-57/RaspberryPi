...
// Hood-Hollow
		union()
		{
			...
			translate(v=[0.000, 0.000, 24.000])
			{
				...
				{
					translate(v=[38.000, 0.000, 6.000])
					{
						union()
						{
...
// Wedge
			...
			translate(v=[50.000, 0.000, 24.000])
			{
...
// Wedge
			...
			color(c=[0.000, 0.000, 0.000])
			{
				translate(v=[62.500, 0.000, 6.000])
				{
					union()
					{
						translate(v=[0.000, 75.000, 0.000])
