...
translate(v=[1.500, 0.000, 0.000])
{
	union()
	{
		...
		{
			translate(v=[1.500, 0.000, -12.500])
			{
// Wedge
				scale(v=[3.000, 10.000, 5.000])
				{
		...
		color(c=[0.000, 1.000, 0.000])
		{
			translate(v=[-4.000, 0.000, -7.500])
			{
				cube(size=[2.000, 10.000, 15.000], center=true);
			}
		}
		translate(v=[-1.500, 0.000, -1.000])
		{
			cube(size=[6.000, 10.000, 2.000], center=true);
		}
	}
}
