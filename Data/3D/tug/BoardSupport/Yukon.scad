...
difference()
{
	union()
	{
		...
		{
			cube(size=[94.000, 77.000, 10.000], center=true);
		}
		color(c=[1.000, 0.000, 0.000])
		{
			linear_extrude(height=2.650, center=false, scale=[1.000, 1.000])
			{
				text(text="Yukon", size=9.000, , font="LiberationSans:style=Regular", , halign="center", , valign="center");
			}
		}
	}
	translate(v=[39.300, 30.800, 0.010])
	{
		union()
		{
