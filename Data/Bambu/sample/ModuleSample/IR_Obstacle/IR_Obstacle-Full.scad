...
// IR_Obstacle/IR_Obstacle-Full
union()
{
// IR_Obstacle/IR_Obstacle-Gray
	color([0.502, 0.502, 0.502])
	{
		difference()
		{
			difference()
			{
				cube(size=[51.000, 34.000, 5.000], center=true);
// IR_Obstacle
				union()
				{
				...
				union()
				{
					difference()
					{
						translate(v=[0.000, 0.000, 0.000])
						{
							minkowski()
							{
								cube(size=[28.000, 11.000, 0.200], center=true);
						...
						translate(v=[0.000, 0.000, 0.000])
						{
							minkowski()
							{
								cube(size=[26.500, 9.500, 0.300], center=true);
								rotate(a=[0.000, 0.000, 90.000])
								{
									cylinder(0.010, 3.000, 3.000, false);
								}
