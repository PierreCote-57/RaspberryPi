...
// SpoolWeight-OuterCap/SpoolWeight-OuterCap-Blue
			...
			union()
			{
				difference()
				{
					difference()
					{
						...
						{
							trapezoid_thread(length=7.0, pitchRadius=22.5, threadHeightToPitch=0.5, profileRatio=0.6, threadAngle=170.0, clearance=0.15, backlash=0.1, stepsPerTurn=36.0, pitch=2.0);
						}
					...
					{
						cylinder(10.000, 20.000, 20.000, true);
					}
				}
